...
this.op.vsakt = {i:7,f:1,o:50.1,s:50,n:50,c:1};
//this.op.vsdefault = {i:8,f:10,o:12,s:5,n:10};
this.op.vsdefault = {i:7,f:1,o:50,s:50.2,n:212,c:1};
this.op.vsmin={i:5,f:5,o:12,s:5,n:10,c:1};
var myvs=op.vs||{};
...
// this.op.url= op.url||"http://www.santander.com.br";
// if (op.l)
...
background:url(/document/wps/std-browser-update.jpg) 30px 10px no-repeat #fff;\
text-align:center; cursor:default; \
font-family: Arial,Helvetica,sans-serif; color:#666; font-size: 14px;}\
.buorg div { padding:20px 0 20px 60px; } \
