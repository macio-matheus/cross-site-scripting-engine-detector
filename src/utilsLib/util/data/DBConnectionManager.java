...
//    private PrintWriter log;
   ...
   */
  static synchronized public DBConnectionManager getInstance(String driver,
      String url, int maxConn, String user, String password) {
    if (instance == null) {
      instance = new DBConnectionManager(driver, url, maxConn, user,
                                         password);
    }
    clients++;
    return instance;
   ...
   */
  private DBConnectionManager(String driver, String url, int maxConn,
                              String user,
                              String password) {
    init(driver, url, maxConn, user, password);
  }
    ...
    if (conn == null) {
      try {
        conn = DriverManager.getConnection(
            "jdbc:postgresql://200.238.126.141:5432/linkws", "postgres", "");
//                conn = DriverManager.getConnection("jdbc:postgresql://200.182.98.143/linkws", "linkws", "2002senha");
      }
      catch (SQLException error) {
        throw new RuntimeException(
            "(DBConnectionManager) Erro ao abrir a conexção. Erro: " +
            error.getMessage());
      }
    }
...
//                log("Initialized pool " + poolName);
   ...
   */
  private void init(String driver, String url, int maxConn, String user,
                    String password) {
//    InputStream is = getClass().getResourceAsStream("/db.properties");
    ...
    /*        String dbProperties =
                ...
                "\n";
         StringBufferInputStream is = new StringBufferInputStream(dbProperties);*/
