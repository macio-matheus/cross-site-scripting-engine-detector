...
public class JSPUtils {
	...
	/**
	 * Redireciona para destinUrl a p�gina atual, usando o melhor m�todo para
	 * isto. Ap�s a chamada deste m�todo, deve-se usar "return" para que o
	 * processamento posterior dentro da p�gina/servlet n�o seja executado.
	 * 
	 */
	...
	/**
	 * Obt�m o cookie, se existir, de um dado nome. S�o passados o array dos
	 * cookies, que s�o obtidos, por exemplo, pela fun��o
	 * <code>request.getCookies();</code>, e o nome do cookie.
	 * 
	 * @param cookies
	 *            Array contendo os cookies entre os quais ser�o pesquisados.
	 * @param cookieName
	 *            Nome do cookie a ser procurado.
	 * @return Retorna <code>null</code> caso o cookie n�o esteja no array ou o
	 *         cookie encontrado.
	 */
	...
	public static void log(String prefix, String content) {
		if (content == null) {
			throw new IllegalArgumentException("Parametro inv�lido: content");
		}
